...
public class AvailabilityTest {
    ...
    public void testGetAvailableTime() {
        Availability testAvail = new Availability("26-02-2021",
                "9:30-10:40");
        assertEquals(testAvail.getAvailableTimeInt("9:30-10:40"),
                "1:10");
        assertEquals(testAvail.getAvailableTimeInt("10:40-12:30"),
                "1:50");
        assertEquals(testAvail.getAvailableTimeInt("0:00-10:40"),
                "10:40");
        assertEquals(testAvail.getAvailableTimeInt("23:01-23:02"),
                "0:01");
    }
    ...
    public void testUpdateDuration2() {
        ...
        assertEquals(testAvail.getDuration(),"09:31-10:40");
    }
